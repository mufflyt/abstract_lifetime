...
**16.3%** of AAGL oral presentations reached full peer-reviewed publication —
**171 of 1,051 evaluated** (95% CI 14.2–18.6). The cohort is **1,106** oral
...
Randomized design (HR 2.15, 95% CI 1.44–3.23) is associated with faster
publication and academic affiliation with *slower* publication (HR 0.64,
0.46–0.90). US location (HR 1.37, 0.86–2.19), male first authorship (HR 0.77,
0.57–1.05) and multicenter conduct (HR 1.39, 0.81–2.39) are not statistically
...
The Cox model reports HR 1.26 per additional author (1.10–1.45, p = 0.001), and
...
effect at three months (HR 1.01, 0.84–1.22), rising to 1.32 (1.14–1.54) at one
year and 1.52 (1.25–1.84) at two. Team size does not buy speed to first
...
across 500 bootstrap refits, `n_authors` is retained 96.0% of the time and
`is_rct` 94.8%, while `is_academic` survives only 50.4% — it is significant in
...
![Horizontal bar chart of bootstrap retention frequency for each logistic-regression term over 500 refits. Number of authors 96.0 percent and randomized trial 94.8 percent are shaded green as robust; academic affiliation 50.4 percent, US-based 33.6 percent, log sample size 27.4 percent, multicenter 23.6 percent and inferred first-author gender 22.2 percent are shaded red as unstable.](output/figures/figure7_predictor_stability.png)
...
ScienceDirect JMIG supplements (12 congress issues)
   ...
   1,153 adjudicated decisions (3 human reviewers + an AUTO pass)
        ...
        ▼
   1,051 evaluated → 171 published · 880 not · 55 unresolved
...
**1,723 passing, <!--manifest-count-->22<!--/manifest-count--> failing,
12 skipped.**
...
11. The proportional-hazards assumption is **violated** (global p = 0.041), and
    ...
    (global p = 0.704, no HR moving more than 2%). `n_authors` is separately
    limited by a ceiling at 5 authors covering 49.3% of the model frame.
12. **Three publications are each credited to two abstracts**, so six of the 171
