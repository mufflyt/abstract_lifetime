...
![Flow diagram showing the same cohort chain with the algorithmic classification tiers broken out: 131 definite, 81 probable, 142 possible, 39 excluded as pre-conference, 713 no match or no candidates.](output/figures/figure1_flow_diagram.png)
